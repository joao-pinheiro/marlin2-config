...
#define STRING_CONFIG_H_AUTHOR "(jpinheiro, Ender-3 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -11, -4 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP       20.0   // (mm) Z height of nozzle between leveling points
