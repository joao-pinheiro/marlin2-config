...
#define STRING_CONFIG_H_AUTHOR "(JoaoPinheiro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire Plus Dual-Z BL-Touch"
...
#define INVERT_Z_DIR true  //A4988 direction is inverted, compared to TMC
